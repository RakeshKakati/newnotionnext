...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Govtdoor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Latest news from around the world', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://govtdoor.com/', // 网站地址
  ...
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://govtdoor.com/', // 备案查询链接，如果用了萌备等备案请在这里填写
