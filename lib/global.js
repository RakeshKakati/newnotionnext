...
export function GlobalContextProvider(props) {
  ...
  // 登录验证相关 - useClerkUser is only defined when Clerk is enabled
  const clerkData = useClerkUser ? useClerkUser() : { isLoaded: true, isSignedIn: false, user: null }
  const { isLoaded, isSignedIn, user } = clerkData
